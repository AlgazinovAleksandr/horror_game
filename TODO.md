...
Саша - реализовывать контур

пойти в красную дверь или в черную
на первом уровне будет спрятана записка - и она даст подсказку, что нужно сделать на уровне контур - проверка на внимательность
можно закинуть несколько на разных уровнях

На одном уровне это записка, на другом - что-то другое

Одну из надписей сделать в Backrooms - инструкция к контуру в каком-то виде
